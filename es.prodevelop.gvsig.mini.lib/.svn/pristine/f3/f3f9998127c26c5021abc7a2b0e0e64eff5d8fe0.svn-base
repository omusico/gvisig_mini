...
public class Initializer {
	...
	private ArrayList<IInitializer> initializers = new ArrayList<IInitializer>();
	...
	public void initialize(Context applicationContext) throws Exception {
		...
		CompatManager.getInstance().registerEncryptor(
				new Encryption(getApplicationContext()));
		...
		for (IInitializer i : initializers)
			i.initialize(this.getApplicationContext());
