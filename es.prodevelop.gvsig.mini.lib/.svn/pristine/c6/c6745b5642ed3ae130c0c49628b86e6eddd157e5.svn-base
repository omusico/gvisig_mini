...
import es.prodevelop.gvsig.mini.activities.SearchActivityWrapper;
...
public class AutoCompleteFilter extends Filter {
	...
	protected FilterResults performFiltering(CharSequence prefix) {
		...
		// FIXME we need some dictionary of words contained in features elements
		// so the AutoCompleteFilter works
		return results;
	}
