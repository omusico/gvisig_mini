...
public class DragNDropAdapter extends BaseAdapter implements RemoveListener,
		DropListener {
	...
	public void onDrop(int from, int to) {
		String tempFrom = mContent.get(from);
		String tempTo = mContent.get(to);
		mContent.set(to, tempFrom);
		mContent.set(from, tempTo);
	}
}