...
import es.prodevelop.gvsig.mini.activities.indexer.FeatureAlphabeticalIndexer;
import es.prodevelop.gvsig.mini.activities.indexer.FeatureDistanceIndexer;
...
public class SearchOptions {
	...
	public SortSectionIndexer getSortIndexer(final Point centerMercator) {
		...
		if (sort.compareTo(context.getResources().getString(
			...
			return new FeatureDistanceIndexer(centerMercator);
		}		
		
		return new FeatureAlphabeticalIndexer();
	}
