...
public class SlideBar extends SeekBar {
	...
	public SlideBar(Context context, IMapView mapView) {
		super(context);
	...
	protected void dispatchDraw(Canvas c) {
		try {
			...
			int maxZoomLevel = mapView.getMRendererInfo().getZOOM_MAXLEVEL()
					- mapView.getMRendererInfo().getZoomMinLevel();
			...
			int currentZoom = mapView.getTempZoomLevel()
					- mapView.getMRendererInfo().getZoomMinLevel();
			float last = j;
