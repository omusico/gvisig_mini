...
//import es.prodevelop.gvsig.mini.overlay.NameFinderOverlay;
...
//		osmap.addAcetateOverlay(new AcetateOverlay(this, osmap,
...
////			pMenu.add(0, 5, 5, R.string.download_guides_text).setIcon(
////					R.drawable.icon_nomada);
...
//					.add(0, 7, 7, R.string.settings_mode_offline).setCheckable(
//							true);
//
//			offlineModeItem
...
//													.getString(
//															R.string.settings_key_offline_maps),
//											item.isChecked(), Map.this);
//							return true;
//						}
//					});
//			mySettings = pMenu.add(0, 8, 8, R.string.Map_31).setIcon(
...
//	}
//
//	public class MyCenterLocation extends AbstractAction {
//
...
//					break;
//				case Map.SHOW_INDETERMINATE_DIALOG:
//					setLoadingVisible(true);
//					if (dialog2 != null)
//						dialog2.show();
//					break;
//				case Map.HIDE_INDETERMINATE_DIALOG:
//					setLoadingVisible(false);
//					if (dialog2 != null)
//						dialog2.dismiss();
//					break;
...
//	}
//
//	public void processOfflineIntentActoin(Intent i) throws Exception {
