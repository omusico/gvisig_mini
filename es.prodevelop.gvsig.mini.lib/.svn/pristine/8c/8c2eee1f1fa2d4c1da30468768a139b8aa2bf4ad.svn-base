...
public class NameFinderFunc extends Functionality {
	...
	public NameFinderFunc(IMapActivity map, int id) {
		super(map, id);
	...
	public class POIHandler extends TaskHandler {
		...
		public void handleMessage(Message msg) {
			...
			case TaskHandler.CANCELED:
				getMap().getMapHandler().sendEmptyMessage(IMapActivity.POI_CANCELED);
				break;
			case TaskHandler.FINISHED:
				getMap().getMapHandler().sendEmptyMessage(IMapActivity.POI_SHOW);
				break;
			case TaskHandler.INITED:
				getMap().getMapHandler().sendEmptyMessage(IMapActivity.POI_INITED);
				break;
