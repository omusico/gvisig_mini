 ...
 */
public class SlidingDrawer2 extends ViewGroup {
     ...
     */
    public SlidingDrawer2(Context context, AttributeSet attrs) {
     ...
     */
    public SlidingDrawer2(Context context, AttributeSet attrs, int defStyle) {
