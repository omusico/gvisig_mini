...
public class FeatureAlphabeticalIndexer extends BaseIndexer {

	FeatureAlphabeticalQuickSort qs;

	public FeatureAlphabeticalIndexer() {
		qs = new FeatureAlphabeticalQuickSort();
	}
	...
	public ArrayList sortAndIndex(Collection list) {
		...
		for (int i = 0; i < size; i++) {
			p = (Feature) sorted[i];
			char poiChar = p.getText().toUpperCase().charAt(0);
