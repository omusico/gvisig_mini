...
//	private ArrayList<IMapControl> controls = new ArrayList<IMapControl>();
//
...
//		super(context);
//		this.addControl(new SelectionControl(this, true));
//		try {
...
//	}
//
//	public void addAcetateOverlay(AcetateOverlay overlay) {
//		acetate = overlay;
//	}
//
...
//			@Override
//			public void run() {
//				map.getMapHandler().sendEmptyMessage(
//						Map.SHOW_INDETERMINATE_DIALOG);
//				try {
//					final List<MapOverlay> overlays = TileRaster.this.mOverlays;
//
...
//
//			try {
//				for (IMapControl control : TileRaster.this.controls)
//					try {
...
//					Toast.makeText(
//							map,
//							String.format(map.getText(R.string.load_online)
//									.toString(), renderer.getNAME()),
//							Toast.LENGTH_LONG).show();
//				}
//			} catch (NoSuchFieldError e) {
//				Log.e("", "", e);
...
//			overlay = it.next();
//			if (overlay instanceof AssignFirstPointOverlay) {
//				if (((AssignFirstPointOverlay) overlay).isRemovable(cat)) {
...
//				overlay = it.next();
//				if (overlay instanceof AssignFirstPointOverlay) {
//					if (((AssignFirstPointOverlay) overlay).isRemovable()) {
//						// overlays.remove(overlay);
//						overlay.setVisible(false);
//						this.removeOverlay(overlay.getName());
//						return true;
