...
public class PlaceSearcher {
	 ...
	 */
	public PlaceSearcher(IMapActivity map, String query){
		try {
//			CompatManager.getInstance().getRegisteredLogHandler().configureLogger(log);
	 ...
	 *                search near to
	 */
	public PlaceSearcher(IMapActivity map, String query, double centerX, double centerY){
		this.map = map;
		...
		try {
			if (this.map != null) {
				if (!query.trim().equals("")) {
					...
					//FIXME NameFinderFunc is deprecated
