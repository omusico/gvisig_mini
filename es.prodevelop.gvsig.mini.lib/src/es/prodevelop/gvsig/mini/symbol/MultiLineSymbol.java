...
public class MultiLineSymbol extends LineSymbol {

	public MultiLineSymbol(int color, float strokeWidth) {
		super(color, strokeWidth);
		// TODO Auto-generated constructor stub
	}
	
	public MultiLineSymbol(float strokeWidth) {
		super(strokeWidth);
		// TODO Auto-generated constructor stub
	}
	...
	public void draw(Canvas c, IMapView maps, JTSFeature feature)
		...
		if (geometry instanceof MultiLineString) {
			MultiLineString geom = (MultiLineString) geometry;
			final int size = geom.getNumGeometries();

			Geometry line;
			for (int i = 0; i < size; i++) {
				line = geom.getGeometryN(i);
				super.drawLine(c, maps, line);
			}
		}
	}
}
