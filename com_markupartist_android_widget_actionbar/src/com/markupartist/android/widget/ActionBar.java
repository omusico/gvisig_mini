...
//        a.recycle();
	...
	public void refreshSelectableActions() {
		for (int i = 0; i < mActionsView.getChildCount(); i++) {
			View actionView = mActionsView.getChildAt(i);
			Object tag = actionView.getTag();
			if (tag != null && tag instanceof SelectableAction) {
				SelectableAction action = (SelectableAction) tag;
				ImageButton button = (ImageButton) actionView
